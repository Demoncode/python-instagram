    ...
    class InstagramAPIMethod(object):
        ...
        def _do_api_request(self, url, method="GET", body=None, headers={}):
            ...
            if status_code == 200:
                ...
                return response_objects, content_obj.get('pagination', {}).get('next_url'), content_obj.get('pagination', {}).get('next_min_id') 
            else:
        ...
        def execute(self):
            ...
            if self.as_generator:
                ...
                content, next, next_min_id = self._do_api_request(url, method, body, headers)
            if self.paginates:
                return content, next, next_min_id
            else:
                return content
